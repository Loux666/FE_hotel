    ...
    <div class="login-card">
      ...
      <form @submit.prevent="submitLogin" class="login-form">
        <div class="form-group">
          ...
          <input type="email" v-model="form.email" class="form-input" required placeholder="Nhập email của bạn" />
        </div>

        <div class="form-group">
          <label class="form-label"><i class="fas fa-lock"></i> Mật khẩu</label>
          <input type="password" v-model="form.password" class="form-input" required placeholder="Nhập mật khẩu" />
        </div>
